...
function addHeader()
{
	...
	<div class="header group">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="img/1.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter()
{
    ...
    <div class="copy-right">
        <p>
            Lý Trần © ' . date("Y") . ' - Information Technology
            <span style="color: #eee; font-weight: bold">16CT</span>
        </p>
    </div>';
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0349639595" style="color: #288ad6;">034.963.95.95</a>
                </li>
            </ul>
        </section>
    </div>';
